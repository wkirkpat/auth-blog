        ...
        return (
          <div key={blog.id} className="card col-4 mr-5 shadow-lg">
            <div className="card-body">
             ...
             <img className="card-img-top border border-dark my-3" src="https://run-the-jewels.s3-us-west-1.amazonaws.com/wallpaper/Zoom/RTJ4_ZoomBackground-0520.png" alt="Card image cap"></img>
